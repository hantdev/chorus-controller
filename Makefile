...
env-check:
	...
	@grep -E '^(POSTGRES_DSN|HTTP_PORT|WORKER_GRPC_ADDR|JWT_SECRET|JWT_EXPIRY|ENV)=' .env | sed 's/=.*/=***/' || true
...
migrate-new:
	@if [ -z "$(NAME)" ]; then \
		...
		echo "Example: make migrate-new NAME=add_user_table"; \
		exit 1; \
	fi
	@echo "Auto-generating migration from GORM models: $(NAME)"
...
migrate-down:
	...
	@GOWORK=off atlas migrate down --env local
...
.PHONY: help
help:
	@echo "🚀 Chorus Controller - Available Commands:"
	@echo ""
	@echo "📦 Build & Run:"
	...
	@echo ""
	@echo "🗄️  Database:"
	@echo "  migrate-new    - Create new migration from GORM models"
	@echo "  migrate-up     - Apply all migrations"
	@echo "  migrate-down   - Rollback last migration"
	@echo "  migrate-status - Show migration status"
	@echo "  migrate-hash   - Update migration checksums"
	@echo "  migrate-reset  - Reset database (⚠️  destructive)"
	@echo ""
	@echo "📚 Documentation:"
